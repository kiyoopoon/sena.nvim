...
--     editor = {
--         image = "neovim_dark",
--         client = "1289291062086729739",
--         tooltip = "The Superior Text Editor for Linux Users",
--     },
--     display = {
--         show_time = true,
...
--     local blacklist_arr = ffi.new("const char*[" .. blacklist_len .. "]", config.display.workspace_blacklist)
--
--     local first_url = config.buttons[1] and config.buttons[1].url
--     local second_url = config.buttons[2] and config.buttons[2].url
--
--     if not first_url or first_url == "git" and not config.display.show_repository then
--         first_url = ""
--     end
--
--     if not second_url or second_url == "git" and not config.display.show_repository then
--         second_url = ""
--     end
--
--     return discord.init(
...
--             local status = discord.update_presence(ffi.new("PresenceArgs", "", "Cord.idle", nil, 0, false))
--             logger.log(status)
--             if status == 6 then
--                 return
...
--     if
--         config.idle.enable
--         and (config.idle.timeout == 0 or (os.clock() - last_updated) * 1000 >= config.idle.timeout)
--     then
...
--     timer:stop()
--     if not utils.validate_severity(config) then
--         return
--     end
